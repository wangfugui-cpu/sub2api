...
const GITHUB_REPO = 'wangfugui-cpu/sub2api'
// Personal CI publishes versioned images to GHCR (tags carry no "v" prefix).
const DOCKER_IMAGE = 'ghcr.io/wangfugui-cpu/sub2api'
