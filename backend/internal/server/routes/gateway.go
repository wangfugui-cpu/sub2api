...
func RegisterGatewayRoutes(
	...
	gateway.GET("/sub2api/identity", h.Gateway.KeyIdentity)
	// Keep personal key identity outside the model allowlist chain: it is an
	// authenticated metadata endpoint, not a model execution request.
