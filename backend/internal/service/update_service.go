...
const (
	...
	// githubRepo is the release feed used by the in-place updater. Keep it
	// independent from the Go module path so personal distributions can receive
	// updates only from releases they publish themselves.
	githubRepo = "wangfugui-cpu/sub2api"
